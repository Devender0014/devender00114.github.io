  ...
  return (
    <div ref={elem} className="project">
      ...
      <ScrollAnimation animateOnce={true} animateIn="fadeIn">
        <div className="box">
          {/* <div className="imgdiv"> */}
          <img className="projectimg" src={blooming} alt="" />
          {/* </div> */}
          <div className="details">
            <div className="linkdiv">
              <a
                rel="noreferrer"
                target="_blank"
                href="https://github.com/Devender0014/organic-pets-4780?organization=Devender0014&organization=Devender0014"
                className="links"
              >
                GITHUB
              </a>
              <a
                rel="noreferrer"
                target="_blank"
                href="https://blooming-cart.netlify.app/"
                className="links"
              >
                LIVE
              </a>
            </div>
            <h3 className="heading">Blooming</h3>
            <div className="description">
              <p>
              Blooming is US web store which sells Flowers and Gift products.
              </p>
            </div>
            <div className="btndiv">
              <button>REACT</button>
